	...
	var Typed = function(el, values, shorten){
		...
		if (!values){
			// custom typed values
			self.values = ["a web developer.", "a web designer.", "Matt."];
		}
		else{
			self.values = values;
		}

		// option to shorten the backspacing
			...
			, backspace: function(curString, curStrPos){
				...
				setTimeout(function() {
					...
					// ----- this part is optional ----- //
						...
						if (self.shorten && self.arrayPos == 0){
							self.stopNum = 5;
						}
