...
const Me = () => (
  <Layout>
    ...
    <p>
      ...
      <a href="http://www.github.com/mattboldt/" className="tg">
        Github
      </a>
      , or{' '}
      <a href="http://www.codepen.io/mattboldt" className="tg">
        Codepen
      </a>
      . By day, I'm a developer at{' '}
      <a href="http://www.kalkomey.com/" className="tg">
        Kalkomey
      </a>
      .
    </p>
    ...
    <p>
      ...
      <a href="http://www.twitter.com/atmattb" className="tg">
        Twitter
      </a>
      .
    </p>
    ...
    <p>
      ...
      nearly half my life, and I also like to write, record, and produce music.
      Lately I've been in an electronic dance phase, of which you can listen to
      on my{' '}
      <a href="http://www.soundcloud.com/in-clouds/" className="tg">
        Soundcloud
      </a>
      .
    </p>
